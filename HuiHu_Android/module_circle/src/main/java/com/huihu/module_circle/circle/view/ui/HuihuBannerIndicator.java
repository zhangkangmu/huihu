package com.huihu.module_circle.circle.view.ui;
 ...
 * @des Huihu的热门banner图指示器
 */

public class HuihuBannerIndicator extends View {
    ...
    public HuihuBannerIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void setStyleable(Context context, AttributeSet attrs) {
        ...
        mSelected_color = array.getColor(R.styleable.ViewPagerIndicator_vpi_selected_color, Color.BLACK);
     ...
     * @param num
     */
    public HuihuBannerIndicator setNum(int num) {
        mNum = num;
        invalidate();
        return this;
    }
     ...
     * @param indicatorType
     */
    public HuihuBannerIndicator setType(int indicatorType) {
     ...
     * @param radius
     */
    public HuihuBannerIndicator setRadius(float radius) {
        this.mRadius = radius;
        invalidate();
        return this;
    }
     ...
     * @param distance
     */
    public HuihuBannerIndicator setDistance(float distance) {
     ...
     * @param mDistanceType
     */
    public HuihuBannerIndicator setDistanceType(int mDistanceType) {
     ...
     * @return
     */
    public HuihuBannerIndicator setViewPager(ViewPager viewPager) {
     ...
     * @return
     */
    public HuihuBannerIndicator setViewPager(ViewPager viewpager, int CycleNumber) {
     ...
     * @return
     */
    public HuihuBannerIndicator setViewPager(ViewPager viewPager, boolean isInfiniteCircle) {
     ...
     * @return
     */
    public HuihuBannerIndicator setViewPager(ViewPager viewpager, int CycleNumber, boolean isInfiniteCircle) {
        mNum = CycleNumber;
