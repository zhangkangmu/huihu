 ...
 * @author  caicancan
 * @time 2019.3.19
 * @des 热门的banner图的viewpager
 * */
public class HuihuLoopingViewPager extends ViewPager {
    OnPageChangeListener mOuterPageChangeListener;
    private HuihuLoopPagerAdapterWrapper mAdapter;
    ...
    public void setAdapter(PagerAdapter adapter) {
        mAdapter = new HuihuLoopPagerAdapterWrapper(adapter);
    ...
    public HuihuLoopingViewPager(Context context) {
        super(context);
        init();
    }

    public HuihuLoopingViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
