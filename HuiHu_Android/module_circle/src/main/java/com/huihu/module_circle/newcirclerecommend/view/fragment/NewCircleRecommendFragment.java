package com.huihu.module_circle.newcirclerecommend.view.fragment;
...
import com.huihu.module_circle.newcirclerecommend.presenter.ImpNewCircleRecommendPresenter;
import com.huihu.module_circle.newcirclerecommend.view.adapter.NewCircleRecommendAdapter;
...
public class NewCircleRecommendFragment extends BaseFragment implements INewCircleRecommendView{
    private final INewCircleRecommendPresenter iNewCircleRecommendPresenter = new ImpNewCircleRecommendPresenter(this);
    private Unbinder unbinder;
    @BindView(R2.id.recycler_view)
    RecyclerView mRecyclerView;
    @BindView(R2.id.refreshLayout)
    SmartRefreshLayout refreshLayout;
    private NewCircleRecommendAdapter adapter;
    private Context mContext;
    private StateLayout stateLayout;
    private LoadingDialog loadingDialog;
    private List<NewCircleRecommendInfo.PageDatasBean> pageDatas;
    private NewCircleRecommendInfo info;
    private static final String CIRCLEID="circleId";
    private static final String UID="uid";
    private Long mCircleId;
    private Long mUid;

    public static NewCircleRecommendFragment newInstance(long circleId,long uid) {
        
        Bundle args = new Bundle();
        args.putLong(CIRCLEID,circleId);
        args.putLong(UID,uid);
        NewCircleRecommendFragment fragment = new NewCircleRecommendFragment();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        builder.setOnRetryClick(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                iNewCircleRecommendPresenter.v2pRequestCircleRecommendList();
            }
        });
...
//                int end = adapter.getmList().size() - 1;
                iNewCircleRecommendPresenter.v2pRequestMoreCircleRecommendList(info);
            }
        });
    }
    ...
    private void initRecyclerView() {
        ...
        adapter = new NewCircleRecommendAdapter(getContext());
...
//        adapter.setOnAttentionItemClickListen(this);
    ...
    @Override
    public void p2vReturnMoreNewCircleRecommendList(NewCircleRecommendInfo info) {
        int oldCount = adapter.getItemCount();
        adapter.getmList().addAll(info.getPageDatas());
        int newCount = adapter.getItemCount();
        adapter.notifyItemRangeInserted(oldCount,newCount);
    }

    @Override
    public void p2vReturnNewCircleRecommendList(NewCircleRecommendInfo info) {
        adapter.setNewCircleRecommendList(info.getPageDatas());
        stateLayout.showContent();
        refreshLayout.setEnableLoadMore(true);
        this.pageDatas=info.getPageDatas();
        this.info=info;
    }
