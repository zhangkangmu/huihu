package com.huihu.module_home.commentchilddialog.adapter;
...
import com.huihu.module_home.commentdialog.adapter.ImageAdapter;
...
public class CommentChildAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int type) {
        if (type == TYPE_NO_MORE) {
            View view = LayoutInflater.from(mContext)
                    .inflate(R.layout.module_home_item_comment_no_more, viewGroup, false);
            return new CommentNoMoreViewHolder(view);
        } else if (type == TYPE_COMMENT_CHILD) {
            View view = LayoutInflater.from(mContext)
                    .inflate(R.layout.module_home_item_comment_child, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof CommentChildViewHolder) {
            if (position == 0 ) {
                ...
                ((CommentChildViewHolder) viewHolder).setView(mContext, mCommentTwoList.get(position - 1), position);
                ((CommentChildViewHolder) viewHolder).setOnClickListener(mOnclickListener);
    ...
    class CommentChildViewHolder extends RecyclerView.ViewHolder {
        ...
        //二级评论界面
        public void setView(Context context, CommentTwo commentTwo, int position) {
            ...
            if (commentTwo.getIsAgree() == 0) {
                ...
                ivLike.setImageBitmap(BitmapUtils.drawableToBitmap(mContext.getResources().getDrawable(R.drawable.module_home_icon_like_blue)));
            }
...
//        }
        ...
        public void setView(CommentHead commentHead, int position) {
            ...
            List<ImagesBean> imageList = commentHead.getCommentImages();
            ...
            tvReplyCount.setText(String.format(mContext.getResources().getString(R.string.module_home_comment_rely), CountUtil.toHuihuCount(commentHead.getReplyNum())));
        }


        /*
        //一级评论头
        public void setView( CommentOne commentOne, int position){
