package com.huihu.module_home.commentchilddialog.entity;
...
public class CommentHead {
    ...
    private List<ImagesBean> commentImages;
    ...
    public List<ImagesBean> getCommentImages() {
        return commentImages;
    }

    public void setCommentImages(List<ImagesBean> commentImages) {
