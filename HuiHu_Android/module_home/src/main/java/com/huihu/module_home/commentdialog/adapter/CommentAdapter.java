package com.huihu.module_home.commentdialog.adapter;
...
import com.huihu.module_home.commentdialog.entity.CommentOne;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int type) {
        ...
        if (type == TYPE_COMMENT_ONE){
            View view = LayoutInflater.from(mContext)
                    .inflate(R.layout.module_home_item_comment_one, viewGroup, false);
    ...
    class CommentOneViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setView(Context mComtext, CommentOne commentOne, int position) {
            ...
            if (commentOne.getIsAgree() == 0) {
                ivLike.setImageBitmap(BitmapUtils.drawableToBitmap(mComtext.getResources().getDrawable(R.drawable.module_home_icon_like)));
            } else {
                ivLike.setImageBitmap(BitmapUtils.drawableToBitmap(mComtext.getResources().getDrawable(R.drawable.module_home_icon_like_blue)));
            }
