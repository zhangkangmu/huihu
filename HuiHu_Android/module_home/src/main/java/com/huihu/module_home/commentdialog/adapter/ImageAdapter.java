...
public class ImageAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        if (mIsChild){
            View view = LayoutInflater.from(mContext).inflate(R.layout.module_home_item_comment_child_image,viewGroup,false);
            return new ImageViewHolder(view);
        }else {
            View view = LayoutInflater.from(mContext).inflate(R.layout.module_home_item_comment_image,viewGroup,false);
            return new ImageViewHolder(view);
        }
