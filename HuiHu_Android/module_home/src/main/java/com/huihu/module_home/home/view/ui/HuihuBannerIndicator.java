package com.huihu.module_home.home.view.ui;
...
public class
HuihuBannerIndicator extends View {
    ...
    private void setStyleable(Context context, AttributeSet attrs) {
        ...
        mSelected_color = array.getColor(R.styleable.ViewPagerIndicator_vpi_selected_color, Color.WHITE);
