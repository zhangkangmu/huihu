...
public class GridViewImageAdapter extends BaseAdapter{
    Context context;
    List<PopularIdeaData.PageDatasBean.ImagesBean> imgList;
    GridViewImageAdapter(Context context, List<PopularIdeaData.PageDatasBean.ImagesBean> imgList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.module_home_gridview_item, null);
