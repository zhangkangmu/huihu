...
public class GridViewImageAdapter extends BaseAdapter {
    Context context;
    List<AttitudeInfo.PageDatasBean.ContentImagesBean> imgList;

    GridViewImageAdapter(Context context, List<AttitudeInfo.PageDatasBean.ContentImagesBean> imgList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (imgList.size()==1){
                ...
                params.width = dip2px(context,355);
