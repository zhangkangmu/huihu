...
public class Authentication {
     ...
     * signature : string
     * uid : 0
     * userAuthShowModelList : [{"authBewrite":"string","authBewriteId":0,"authCondition":"string","authName":"string","authOrder":0,"authState":0,"incMax":"string","incMin":"string"}]
    ...
    public static class UserAuthShowModelListBean {
        ...
        public int getAuthBewriteId() {
            return authBewriteId;
        }

        public void setAuthBewriteId(int authBewriteId) {
            this.authBewriteId = authBewriteId;
        }
