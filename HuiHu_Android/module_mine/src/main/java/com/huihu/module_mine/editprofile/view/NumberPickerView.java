...
public class NumberPickerView extends View{
    ...
    private static final int DEFAULT_TEXT_COLOR_NORMAL = 0XFFBBBBBB;
    ...
    private void drawContent(Canvas canvas){
        ...
        for(int i = 0; i < mShowCount + 1; i++){
            ...
            }else if(Math.abs(i - mShowCount / 2) == 1){
                textColor = getEvaluateColor(0.5f, mTextColorNormal, mTextColorSelected);
                textSize = getEvaluateSize(0.5f, mTextSizeNormal, mTextSizeSelected);
                textSizeCenterYOffset = getEvaluateSize(0.5f, mTextSizeNormalCenterYOffset,
                        mTextSizeSelectedCenterYOffset);
            }else{
