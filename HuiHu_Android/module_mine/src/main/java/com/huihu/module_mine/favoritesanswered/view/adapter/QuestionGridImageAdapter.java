...
public class QuestionGridImageAdapter extends BaseAdapter {
    Context mContext;
    List<FavoritesAnsweredInfo.PageDatasBean.ImagesBean> imgList;

    public QuestionGridImageAdapter(Context mContext, List<FavoritesAnsweredInfo.PageDatasBean.ImagesBean> images) {
