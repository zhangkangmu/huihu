...
public class GridViewImageAdapter extends BaseAdapter {
    Context context;
    List<FavoritesDiscussInfo.PageDatasBean.ImagesBean> imgList;

    GridViewImageAdapter(Context context, List<FavoritesDiscussInfo.PageDatasBean.ImagesBean> imgList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.module_mine_gridview_item, null);
        ...
        ImgTools.showImageViewWithConner(context,imgList.get(position).getImageUrl(),viewHodler.imageView,2);
        return convertView;
}
        class ViewHodler{
    ImageView imageView;
