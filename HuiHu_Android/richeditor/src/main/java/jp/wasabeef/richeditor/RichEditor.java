...
public class RichEditor extends WebView {
    ...
    public void setPageFinishListener(OnPageFinishListener pageFinishListener) {
        mPageFinishListener = pageFinishListener;
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (mPageFinishListener != null && mIsLoadFinsih && !mIsExpand) {
            mPageFinishListener.onPageFinish();
        }
    }
