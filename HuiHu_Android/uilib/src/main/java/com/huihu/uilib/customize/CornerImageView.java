...
public class CornerImageView extends ImageView {
    ...
    public CornerImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < ta.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.CornerImageView_is_cover_src) {
                isCoverSrc = ta.getBoolean(attr, isCoverSrc);
            } else if (attr == R.styleable.CornerImageView_is_circle) {
            ...
            } else if (attr == R.styleable.CornerImageView_inner_border_width) {
                innerBorderWidth = ta.getDimensionPixelSize(attr, innerBorderWidth);
            } else if (attr == R.styleable.CornerImageView_inner_border_color) {
            ...
            } else if (attr == R.styleable.CornerImageView_mask_color) {
