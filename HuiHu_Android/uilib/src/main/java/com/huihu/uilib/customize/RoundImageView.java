...
public class RoundImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        type = a.getInt(R.styleable.RoundImageView_type, 1);// 默认为Circle
        a.recycle();
    }

    public void setCustomAttributes(int mBorderThickness, int mBorderOutsideColor, int mBorderInsideColor) {
...
//		Bitmap bitmap = b.copy(Bitmap.Config.ARGB_4444, true);
            ...
            if (b != null) {
                ...
                roundBitmap = getCroppedRoundBitmap(b, radius);
    ...
    public Bitmap getCroppedRoundBitmap(Bitmap bmp, int radius) {
        ...
        if (type == TYPE_CIRCLE) {
            ...
            RectF rect1 = new RectF(0, 0, scaledSrcBmp.getWidth(), scaledSrcBmp.getHeight());
            canvas.drawRoundRect(rect1, 10f, 10f, paint);
        }
    ...
    private void drawCircleBorder(Canvas canvas, int radius, int color) {
        ...
        if (type == TYPE_CIRCLE) {
            ...
            RectF rect = new RectF(0, 0, defaultWidth, defaultHeight);
    ...
    private Bitmap getRoundConerImage(Bitmap source) {
        ...
        paint.setAntiAlias(true);
        Bitmap target = Bitmap.createBitmap(defaultWidth, defaultHeight, Config.ARGB_4444);
