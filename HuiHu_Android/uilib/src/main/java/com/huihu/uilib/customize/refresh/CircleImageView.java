...
class CircleImageView extends ImageView {
    ...
    private class OvalShadow extends OvalShape {
        ...
        private void updateRadialGradient(int diameter) {
            this.mRadialGradient = new RadialGradient((float) (diameter / 2), (float) (diameter / 2), (float)
                    CircleImageView.this.mShadowRadius, new int[]{1023410176, 0}, (float[]) null, TileMode.CLAMP);
