 ...
 * @author caicancan
 * @time 2019.3.26
 * @function 上拉加载的自定义view
 * */
public class HuihuSmartRefreshFooter extends LinearLayout implements RefreshFooter {
    private CircularProgressDrawable circularProgressDrawable;;//刷新动画
    private CircleImageView mCircleView;//刷新动画视图

    public HuihuSmartRefreshFooter(Context context) {
        super(context);
        initView(context);
    }

    public HuihuSmartRefreshFooter(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context);
    }
    public HuihuSmartRefreshFooter(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        //circularProgressDrawable.setColorSchemeColors(getResources().getColor(R.color.module_home_blue));
