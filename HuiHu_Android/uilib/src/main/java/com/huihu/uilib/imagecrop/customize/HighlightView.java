...
public class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(R.drawable.icon_camera_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(R.drawable.icon_camera_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(R.drawable.icon_indicator_autocrop);
    }
        ...
        if (!hasFocus()) {
            ...
            if (mCircle) {
                ...
                path.addCircle(mDrawRect.left + (width / 2),
                        ...
                        width / 2,
                        Path.Direction.CW);
                mOutlinePaint.setColor(mContext.getResources().getColor(R.color.uilib_image_crop_circle));
                ...
                mOutlinePaint.setColor(mContext.getResources().getColor(R.color.uilib_image_crop_rect));
